...
router.post('/caption', async (req, res) => {
  try {
    const { command, brand, tone, location, platforms, mediaContext } = req.body;
...
4. Parse time references with EXACT PRECISION — "1:30pm" means 13:30:00, "1:40pm" means 13:40:00. NEVER round to nearest hour. Include exact minutes always.
5. Generate relevant hashtags for the business type and location
6. Write separate captions for each platform — Facebook longer/conversational, Instagram punchy with emojis

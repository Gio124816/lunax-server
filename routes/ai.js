...
router.post('/caption', async (req, res) => {
  try {
    const { command, brand, tone, location, platforms, mediaContext, videoTranscript, images, fileNames, knownNames } = req.body;
